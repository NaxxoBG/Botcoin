...
public class CoinTickerConstants {
	...
	static final String ETH_URL = "https://api.cryptonator.com/api/ticker/ethusd";
	static final String ALT_COINS_URL = "https://api.cryptonator.com/api/ticker/holder-usd";
